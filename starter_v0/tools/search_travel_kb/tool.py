...
KB_DIR = ROOT / "tourism_data" / "knowledge_base"
...
def _split_trusted_content(body: str) -> tuple[str, list[str]]:
    ...
    suspicious_markers = (
        ...
        "bo qua chi dan", "bỏ qua chỉ dẫn", "call create_support_ticket",
...
def search_travel_kb(query: str = "", category: str = "all", top_k: int = 3) -> dict[str, Any]:
    """Search VietTravel knowledge base (visa/refund/payment/booking/insurance)."""
    try:
        ...
        for path in sorted(KB_DIR.glob("*.md")):
            ...
            hits.append({
                ...
                "source": "VietTravel Knowledge Base",
        ...
        return err("search_travel_kb", exc)
